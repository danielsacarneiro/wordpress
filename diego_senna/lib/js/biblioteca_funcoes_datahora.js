...
// Formato o campo data "pCampo" passado como par�metro no formato mm/aaaa
...
// Formato o campo data "pCampo" passado como par�metro no formato dd/mm
...
// Formato o campo hora "pCampo" passado como par�metro no formato hh:mm
...
// Verifica se existe uma hora v�lida no campo "pCampo" passado como parametro
...
// Formato o campo data "pCampo" passado como par�metro no formato aaaa-b 
...
// Verifica se o per�odo informado � v�lido
...
// Verifica se o per�odo de data e hota informado � v�lido
...
// Fun��o que verifica se duas datas est�o dentro de um intervalo em dias definido.
...
// Fun��o que verifica se duas datas est�o dentro de um intervalo em meses definido.
...
// Fun��o que verifica se duas datas est�o dentro de um intervalo em anos definido.
...
// Fun��o que avan�a uma Data de referencia em uma quantidade definida de meses
...
// Fun��o que avan�a uma Data de referencia em uma quantidade definida de anos
...
//Retorna a quantidade de dias entre as duas datas passadas como par�metros
...
//Retorna a quantidade de meses entre as duas datas passadas como par�metros
function getQtMeses(pDataInicial, pDataFinal) {
	...
	//Verifica qual � a maior e menor data.
	...
	//Se os anos das datas s�o iguais, retorna-se a diferen�a entre os meses.
	//Caso contr�rio, retorna-se a quantidade de meses que falta pra o ano1(ano menor) acabar,
	//somada � quantidade de meses que j� se passaram do ano2(ano maior) e, caso exista,
	//os 12 meses referentes aos anos que est�o entre o ano1 e ano2.
	if (ano2 == ano1) {
		retorno = mes2 - mes1;
	} else {
