...
class voperfilaluno extends voentidade {
	...
	static $ID_REQ_NmCaixas = "ID_REQ_NmCaixas";
	static $qtdMateriasPorDia = 2;
	...
	static $nmAtrNumHorasMateriaDia = "perfaluno_horaspormateriadia";
	static $nmAtrNumHorasDia = "perfaluno_horasdia";
	...
	function getValoresWhereSQLChaveLogicaSemSQ($isHistorico) {
		...
		$query .= " AND $nmTabela." . self::$nmAtrCdAluno . "=" . $this->cdAluno;
	...
	function getDadosRegistroBanco($registrobanco) {
		...
		$this->numHorasDia = $registrobanco [self::$nmAtrNumHorasDia];
	...
	function getDadosFormulario() {
		...
		$this->numHorasDia = @$_POST [self::$nmAtrNumHorasDia];
	...
	function getMensagemComplementarTelaSucesso() {
		if ($this->cdPerfil != null && getFuncao () != constantes::$CD_FUNCAO_EXCLUIR) {
