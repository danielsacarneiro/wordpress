...
$caminhoabs = str_replace("funcoes", "", dirname(__FILE__));
//define('caminho_abs', dirname(__FILE__) . '/');
	
include_once($caminhoabs."config_sistema.php");
...
setCabecalhoPorNivel("Confirmação",1);
$funcao = @$_POST["funcao"];
//echo $funcao;
