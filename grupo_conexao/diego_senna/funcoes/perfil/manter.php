...
<INPUT type="hidden" id="<?=voperfil::$nmAtrCd?>" name="<?=voperfil::$nmAtrCd?>" value="<?=$vo->cd?>">
    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" colspan=3><INPUT type="text" id="<?=voperfil::$nmAtrDescricao?>" name="<?=voperfil::$nmAtrDescricao?>"  value="<?php echo($vo->descricao);?>"  class="camponaoobrigatorio" size="50" required></TD>
            </TR>
