    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" colspan=3><INPUT type="text" id="<?=voperfil::$nmAtrDescricao?>" name="<?=voperfil::$nmAtrDescricao?>"  value="<?php echo($vo->descricao);?>"  class="camporeadonly" size="50" readonly></TD>
            </TR>  
