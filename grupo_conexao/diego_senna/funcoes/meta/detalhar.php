    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" colspan=3><INPUT type="text" id="<?=vomateria::$nmAtrDescricao?>" name="<?=vomateria::$nmAtrDescricao?>"  value="<?php echo($vo->descricao);?>"  class="camporeadonly" size="50" readonly></TD>
            </TR>  
            <TR>
	            <TH class="campoformulario" nowrap width=1%>Valor Mensal:</TH>
	            <TD class="campoformulario" colspan="3"><INPUT type="text" id="<?=vomateria::$nmAtrValor?>" name="<?=vomateria::$nmAtrValor?>" value="<?php echo(getMoeda($vo->valor));?>"
	            class="camporeadonlyalinhadodireita" size="15" readonly></TD>
	        </TR>					            
			<TR>
                <TH class="campoformulario" nowrap width=1%>Observação:</TH>
                <TD class="campoformulario" colspan=3>
                				<textarea rows="2" cols="60" id="<?=vomateria::$nmAtrObservacao?>" name="<?=vomateria::$nmAtrObservacao?>" class="camporeadonly" maxlength="300" readonly><?php echo($vo->obs);?></textarea>
				</TD>
            </TR>                 
