...
function selecionar() {
	...
	if (window.opener != null) {
		...
		window.opener.transferirDadosMateria(cdMateria, dsMateria);
		window.close();
	}
}
         ...
         <TABLE id="table_tabeladados" class="tabeladados" cellpadding="0" cellspacing="0">						
             <TBODY>
                ...
                <TR class="dados">
                    ...
                    <TD class="tabeladados"><?php echo complementarCharAEsquerda($colecao[$i][vomateria::$nmAtrCd], "0", TAMANHO_CODIGOS_SAFI);?></TD>
