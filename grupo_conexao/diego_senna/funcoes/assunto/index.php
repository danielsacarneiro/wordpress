...
$titulo = "CONSULTAR " . voassunto::getTituloJSP();
setCabecalho($titulo);
	
$filtro  = new filtroManterAssunto();
...
function detalhar(isExcluir) {    
	...
	location.href="manter.php?funcao=" + funcao + "&chave=" + chave + "&lupa="+ lupa;
}
             ...
             <TBODY>
                <TR>
                  <TH class="headertabeladados" width="1%" rowspan=2>&nbsp;&nbsp;X</TH>
                    ...
                    <TH class="headertabeladados" width="1%" rowspan=2>Id</TH>
                    <TH class="headertabeladados" width="1%" rowspan=2>Descrição</TH>
                    <TH class="headertabeladadosalinhadocentro" width="1%" colspan=3>Qtd.Leitura</TH>
                </TR>
                <TR>
					<TH class="headertabeladados" width="1%" nowrap>Lei Seca</TH>
					<TH class="headertabeladados" width="1%">Doutrina</TH>
					<TH class="headertabeladados" width="1%">Questões</TH>
                </TR>
                <?php								
                if (is_array($colecao))
                ...
                <TR class="dados">
                    ...
                    <TD class="tabeladados"><?php echo $voAtual->idAssunto;?></TD>
                    <TD class="tabeladados"><?php echo $voAtual->ds;?></TD>
                    <TD class="tabeladados"><?php echo complementarCharAEsquerda($voAtual->inLeiSeca, "0", TAMANHO_CODIGOS_SAFI);?></TD>                    
					<TD class="tabeladados"><?php echo complementarCharAEsquerda($voAtual->inDoutrina, "0", TAMANHO_CODIGOS_SAFI);?></TD>
					<TD class="tabeladados"><?php echo complementarCharAEsquerda($voAtual->inQuestoes, "0", TAMANHO_CODIGOS_SAFI);?></TD>                    
                </TR>					
                <?php
				}				
                ?>
