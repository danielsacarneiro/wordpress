        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" colspan=3>
                	Cd. <?=getInputText(vomateriafonte::$nmAtrCdMateria, vomateriafonte::$nmAtrCdMateria, complementarCharAEsquerda($vo->cdMateria, "0", TAMANHO_CODIGOS_SAFI), $class)?>
			...
			<TR>
				...
				Descrição: <?=getInputText(vomateriafonte::$nmAtrDescricao, vomateriafonte::$nmAtrDescricao, $vo->descricao, constantes::$CD_CLASS_CAMPO_READONLY, 50)?>
				</TD>
            </TR>            
        <?php if(!$isInclusao){
