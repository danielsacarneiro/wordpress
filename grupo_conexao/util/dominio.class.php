...
class dominio extends multiplosConstrutores {
	...
	static function getDetalhamentoHtml($chave, $idCampo=null, $nmCampo=null) {	
		$ds = static::getDescricaoStatic($chave);
		$retorno = getInputText("", "",$ds,constantes::$CD_CLASS_CAMPO_READONLY, strlen($ds));
		$retorno .= getInputHidden($idCampo, $nmCampo, $chave);		
		return $retorno;
	}
