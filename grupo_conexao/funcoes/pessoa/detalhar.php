    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" ><INPUT type="text" id="<?=vopessoa::$nmAtrDocCPF?>" name="<?=vopessoa::$nmAtrDocCPF?>" value="<?php echo(documentoPessoa::getNumeroDocFormatado($vo->docCPF));?>" class="camporeadonly" size="20" maxlength="18" readonly></TD>
            </TR>
			<TR>
			...
			<TR>
                ...
                <TD class="campoformulario" ><INPUT type="text" id="<?=vopessoa::$nmAtrTelWapp?>" name="<?=vopessoa::$nmAtrTelWapp?>"  value="<?php echo($vo->telWapp);?>"  class="camporeadonly" size="14" maxlength="12" readonly></TD>                
            </TR>    
            <?php 
