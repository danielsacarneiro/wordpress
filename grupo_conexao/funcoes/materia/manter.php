...
function isFormularioValido() {
	if (!isCampoMoedaComSeparadorMilharValido(document.frm_principal.<?=vomateria::$nmAtrValor?>, 2, false))
		return false;		
	return true;
}
...
<INPUT type="hidden" id="<?=vomateria::$nmAtrCd?>" name="<?=vomateria::$nmAtrCd?>" value="<?=$vo->cd?>">
    ...
    <TBODY>
        ...
        <TR>
			...
			<TR>
                ...
                <TD class="campoformulario" colspan=3><INPUT type="text" id="<?=vomateria::$nmAtrDescricao?>" name="<?=vomateria::$nmAtrDescricao?>"  value="<?php echo($vo->descricao);?>"  class="camponaoobrigatorio" size="50" required></TD>
            </TR>
			<TR>
	            <TH class="campoformulario" nowrap width=1%>Valor Mensal:</TH>
	            <TD class="campoformulario" colspan="3"><INPUT type="text" id="<?=vomateria::$nmAtrValor?>" name="<?=vomateria::$nmAtrValor?>" required value="<?php echo(getMoeda($vo->valor));?>"
			...
			<TR>
                ...
                <TD class="campoformulario" colspan=3>
                				<textarea rows="2" cols="60" id="<?=vomateria::$nmAtrObservacao?>" name="<?=vomateria::$nmAtrObservacao?>" class="camponaoobrigatorio" maxlength="300"><?php echo($vo->obs);?></textarea>
				</TD>
            </TR>                 
